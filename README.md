...
Kjør prosjektet (for både backend/frontend)
```
npm start
```
...
- Effektivisere og forenkle algoritme for å finne grupper som er kompatible
- Utvide for kurs utenfor UIO

### Takk til

- Roomies Espen og Gorm for testing og feedback
